...
@Getter
@Entity
@Table(name = DBConstant.C_LOAI_CHE_DO_THANH_TRA)
@JsonIgnoreProperties(ignoreUnknown = true)
public class RDBMSLoaiCheDoThanhTra extends RDBMSBaseCategory<RDBMSLoaiCheDoThanhTra> {

    private static final long serialVersionUID = 1L;

    public RDBMSLoaiCheDoThanhTra() {
        super(false);
        super.setType(getType());
    }

    public RDBMSLoaiCheDoThanhTra(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
