...
@Setter
@Getter
@Document(collection = DBConstant.C_HINH_THUC_PHAT_BO_SUNG)
@JsonIgnoreProperties(ignoreUnknown = true)
public class HinhThucPhatBoSung extends BaseCategory<HinhThucPhatBoSung> {

    private static final long serialVersionUID = 1L;

    public HinhThucPhatBoSung() {
        super(false);
        super.setType(getType());
    }

    public HinhThucPhatBoSung(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
