...
@Setter
@Getter
@Document(collection = DBConstant.C_NGHI_DINH_XPVPHC)
@JsonIgnoreProperties(ignoreUnknown = true)
public class NghiDinhXPVPHC extends BaseCategory<NghiDinhXPVPHC> {

    private static final long serialVersionUID = 1L;

    public NghiDinhXPVPHC() {
        super(false);
        super.setType(getType());
    }

    public NghiDinhXPVPHC(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
