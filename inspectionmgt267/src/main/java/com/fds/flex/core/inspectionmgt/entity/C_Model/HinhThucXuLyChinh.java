...
@Setter
@Getter
@Document(collection = DBConstant.C_HINH_THUC_XU_LY_CHINH)
@JsonIgnoreProperties(ignoreUnknown = true)
public class HinhThucXuLyChinh extends BaseCategory<HinhThucXuLyChinh> {

    private static final long serialVersionUID = 1L;

    public HinhThucXuLyChinh() {
        super(false);
        super.setType(getType());
    }

    public HinhThucXuLyChinh(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
