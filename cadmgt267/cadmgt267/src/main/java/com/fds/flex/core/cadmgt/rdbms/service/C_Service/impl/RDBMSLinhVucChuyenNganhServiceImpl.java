...
import com.fds.flex.core.cadmgt.rdbms.entity.C_Model.RDBMSLinhVucChuyenNganh;
import com.fds.flex.core.cadmgt.rdbms.repository.C_Repository.RDBMSLinhVucChuyenNganhRepository;
import com.fds.flex.core.cadmgt.rdbms.service.C_Service.RDBMSLinhVucChuyenNganhService;
...
public class RDBMSLinhVucChuyenNganhServiceImpl implements RDBMSLinhVucChuyenNganhService {
    //@Autowired
    private RDBMSLinhVucChuyenNganhRepository rdbmsLinhVucChuyenNganhRepository;
    ...
    public Optional<RDBMSLinhVucChuyenNganh> findById(String id) {
        return rdbmsLinhVucChuyenNganhRepository.findById(Long.valueOf(id));
    }

    @Override
    public void deleteLinhVucChuyenNganh(RDBMSLinhVucChuyenNganh rdbmsLinhVucChuyenNganh) {
        rdbmsLinhVucChuyenNganhRepository.delete(rdbmsLinhVucChuyenNganh);
    }

    @Override
    public RDBMSLinhVucChuyenNganh updateLinhVucChuyenNganh(RDBMSLinhVucChuyenNganh rdbmsLinhVucChuyenNganh) {
        return rdbmsLinhVucChuyenNganhRepository.saveAndFlush(rdbmsLinhVucChuyenNganh);
    }
    ...
    public Map<String, RDBMSLinhVucChuyenNganh> update(Map<String, RDBMSLinhVucChuyenNganh> map) {
        map.forEach((k, v) -> {
            if(k.equals(TrangThaiDuLieu.TrangThai.CanXoa.getMaMuc())) {
                rdbmsLinhVucChuyenNganhRepository.delete(v);
            } else {
                rdbmsLinhVucChuyenNganhRepository.saveAndFlush(v);
            }
        });
        return map;
    }
    ...
    @Override
    public Page<RDBMSLinhVucChuyenNganh> filter(String keyword, String loaiVuViecDonThu_MaMuc, String[] trangThaiDuLieu_MaMuc, Pageable pageable) {
    ...
    public List<RDBMSLinhVucChuyenNganh> findByMaMucAndTrangThaiDuLieu(String maMuc, String[] trangThaiDuLieu_MaMuc) {
        return rdbmsLinhVucChuyenNganhRepository.findByMaMucAndTrangThaiDuLieu(maMuc, trangThaiDuLieu_MaMuc);
    }
