...
@Getter
@Entity
@Table(name = DBConstant.C_LOAI_PHUC_TAP_KEO_DAI)
@JsonIgnoreProperties(ignoreUnknown = true)
public class RDBMSLoaiPhucTapKeoDai extends RDBMSBaseCategory<RDBMSLoaiPhucTapKeoDai> {
    private static final long serialVersionUID = 1L;

    public RDBMSLoaiPhucTapKeoDai() {
        super(false);
        super.setType(getType());
    }

    public RDBMSLoaiPhucTapKeoDai(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
