...
@Setter
@Getter
@Document(collection = DBConstant.C_LINH_VUC_CHUYEN_NGANH)
@JsonIgnoreProperties(ignoreUnknown = true)
public class LinhVucChuyenNganh extends BaseCategory<LinhVucChuyenNganh> {
    ...
    public LinhVucChuyenNganh() {
        super(false);
        super.setType(getType());
    }

    public LinhVucChuyenNganh(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
