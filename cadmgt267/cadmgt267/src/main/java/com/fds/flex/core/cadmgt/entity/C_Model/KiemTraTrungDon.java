...
@Setter
@Getter
@Document(collection = DBConstant.C_KIEM_TRA_TRUNG_DON)
@JsonIgnoreProperties(ignoreUnknown = true)
public class KiemTraTrungDon extends BaseCategory<KiemTraTrungDon> {

    private static final long serialVersionUID = 1L;

    public KiemTraTrungDon() {
        super(false);
        super.setType(getType());
    }

    public KiemTraTrungDon(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
