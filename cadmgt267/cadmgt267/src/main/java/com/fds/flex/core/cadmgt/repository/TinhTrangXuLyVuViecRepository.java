...
@Repository
@Transactional
public interface TinhTrangXuLyVuViecRepository extends MongoRepository<TinhTrangXuLyVuViec, String> {
    ...
    List<TinhTrangXuLyVuViec> findByTrangThaiDuLieu(String trangThaiDuLieu_MaMuc);
}
