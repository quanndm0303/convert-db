...
@Getter
@Entity
@Table(name = DBConstant.C_CHE_DO_TIEP_CONG_DAN)
@JsonIgnoreProperties(ignoreUnknown = true)
public class RDBMSCheDoTiepCongDan extends RDBMSBaseCategory<RDBMSCheDoTiepCongDan> {

    private static final long serialVersionUID = 1L;

    public RDBMSCheDoTiepCongDan() {
        super(false);
        super.setType(getType());
    }

    public RDBMSCheDoTiepCongDan(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
