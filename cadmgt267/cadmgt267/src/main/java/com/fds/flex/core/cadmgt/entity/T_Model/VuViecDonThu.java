package com.fds.flex.core.cadmgt.entity.T_Model;
...
@Setter
@Getter
@Document(collection = DBConstant.T_VU_VIEC_DON_THU)
@JsonIgnoreProperties(ignoreUnknown = true)
public class VuViecDonThu extends BaseModel<VuViecDonThu> {
    ...
    public VuViecDonThu(boolean isUpdate) {
        super(isUpdate);
        super.setType(getType());
    }
